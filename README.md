...
First, download and unzip [INSERT RESOURCPACK PATH FOLDER WHEN DONE HERE] and put it in your `minecraft/resourcepacks` folder. Activate it by going to the "Resource Packs" menu and moving the newly installed file to the right side.
