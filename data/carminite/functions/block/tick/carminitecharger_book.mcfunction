...
data modify storage carminite:block chargerpoppedenchantment set from storage carminite:block chargerstorage.tag.StoredEnchantments[0]
data remove storage carminite:block chargerstorage.tag.StoredEnchantments[0]
